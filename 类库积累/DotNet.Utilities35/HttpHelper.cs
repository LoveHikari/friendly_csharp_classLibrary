...
namespace DotNet.Utilities
{
    ...
    public class HttpHelper
    {
        ...
        {
            return HttpRequest(url, "POST", postDataStr, chareset, headerItem, cookies, ""); //(string retHtml, string cookies)
        }
        ...
        {
            return HttpRequest(url, "POST", postDataStr, chareset, headerItem, null, cookie);  //(string retHtml, string cookies)
        }
        ...
        {
            return HttpRequest(url, "GET", getDataStr, chareset, headerItem, cookies, ""); //(string retHtml, string cookies)
        }
        ...
        {
            return HttpRequest(url, "GET", getDataStr, chareset, headerItem, null, cookie);  //(string retHtml, string cookies)
        }
        #endregion
        ...
        private static object[] HttpRequest(string url, string qequest, string dataStr, string chareset, Hashtable headerItem, CookieContainer cookies, string cookie)
        {
            ...
            using (Stream myResponseStream = response.GetResponseStream())
            {
                using (StreamReader myStreamReader = new StreamReader(myResponseStream, Encoding.GetEncoding(chareset)))
                {
                    ...
                    request.Abort();
                    return new Object[]{ retString, cookie };  //(string retHtml, string cookies)
                }
            }
        }
        #endregion
